...
class RPGinia {
	 ...
	 * @param {String} appPath - App path. Recommend to use __dirname
	 */
	constructor(environment = cfg.getOption('projectEnvironment'), appPath) {
		console.log(appPath);
		/**
		...
		if(this._appPath !== cfg.getOption('projectPath'))
			cfg.setOption('projectPath', this._appPath);
	}
}
